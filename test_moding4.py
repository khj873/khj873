                    ...
                    if cd[0]['time']!=매수시간:
                        ...
                        if cd[매수봉]['high']<=cd[0]['low'] and 손절수정==False:
                            if cd[0]['close']<cd[1]['low']:
                                ...
                                손절점=(cd[0]['low']-cd[매수봉]['high'])/2+cd[매수봉]['high']
                                손절수정=True
                        '''
                        if cd[매수봉]['high']<=cd[0]['low'] and 손절수정==False:
                            if cd[0]['close']<cd[1]['low']:
            ...
            for ticker in tickers:
                ...
                for i in range(2, len(bb)):
                    ...
                    if cd[i]['low']>bb[i]['BL']:
                        break
                if gobuy:
                    if cd[2]['low']<bb[2]['BL'] and cd[0]['low']>cd[2]['low'] and cd[1]['open']<cd[1]['close'] and cd[1]['open']>bb[1]['BL'] and cd[0]['close']<bb[0]['BM'] and float(ma5[2])>bb[2]['BL']:
                        매수가=cd[1]['close']
                        최종매수가격[ticker]=cd[1]['close']

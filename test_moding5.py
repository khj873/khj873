        ...
        if len(account)>=2:
            ...
            for ac in account:
                if ac['currency']!='KRW':
                    ...
                    cd, bb, ma5=get_bb50(ticker, '5', '200', 100)
                    if 매수반넘음:
                        cd, bb, ma5=get_bb50(ticker, '10', '200', 100)
                    매수봉=0
                    ...
                    for i in range(1, 30):
                        ...
                        if (cd[0]['close']+매도차이*i) / float(ac['avg_buy_price']) > 1.005:
            ...
            for ticker in tickers:
                ...
                if ma5[0] > ma5[1]:
                    gobuy=True
                if gobuy:
                    if cd[2]['open']<cd[2]['close'] and cd[1]['open']>cd[1]['close'] and cd[0]['open']<cd[0]['close'] and cd[2]['high']<cd[0]['close']:
                        매수가=cd[0]['close']
